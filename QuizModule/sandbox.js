...
$('#quizDescriptionModel').modal('toggle');
    $('#quizDescriptionModel').on('shown.bs.modal', function () {
        $('#myInput').trigger('focus')
    })

$('#quizDescriptionLeave').on('click', function(){
    window.location.replace("index.html");
})

$('#quizDescriptionContinue').on('click', function(){
